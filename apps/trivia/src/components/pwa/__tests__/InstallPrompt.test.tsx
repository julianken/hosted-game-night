...
describe('InstallPrompt', () => {
  ...
  it('does not show by default (no beforeinstallprompt event)', () => {
    ...
    expect(screen.queryByText('Install Trivia Night')).not.toBeInTheDocument();
  });
  ...
  describe('beforeinstallprompt event handling', () => {
    it('shows install prompt when beforeinstallprompt event fires', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Install Trivia Night')).toBeInTheDocument();
      });
  ...
  describe('styling and accessibility', () => {
    it('renders with correct positioning classes', async () => {
      ...
      await waitFor(() => {
        const container = screen.getByText('Install Trivia Night').closest('div.fixed');
