    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'X-DNS-Prefetch-Control', value: 'on' },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; connect-src 'self' https://*.supabase.co https://*.grafana.net /monitoring; font-src 'self'; frame-src 'none'",
          },
        ],
      },
    ];
