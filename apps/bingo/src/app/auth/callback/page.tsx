  ...
  useEffect(() => {
    async function handleCallback() {
      try {
        ...
        const storedState = sessionStorage.getItem(`bingo_oauth_state_${state}`);
        ...
        const codeVerifier = sessionStorage.getItem(`bingo_pkce_verifier_${state}`);
        if (!codeVerifier) {
        ...
        sessionStorage.removeItem(`bingo_pkce_verifier_${state}`);
        sessionStorage.removeItem(`bingo_oauth_state_${state}`);
