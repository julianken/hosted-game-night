...
Accessible design tokens and CSS variables for the Hosted Game Night. Provides a comprehensive design system with 10+ color themes, accessibility-focused font sizes (18px minimum), and WCAG-compliant touch targets (44px minimum).
