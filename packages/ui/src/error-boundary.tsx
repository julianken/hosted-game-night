...
/**
 * ErrorBoundary - Catches runtime errors and displays an accessible error UI.
 * Uses CSS custom properties (bg-primary) so it adapts to each app's theme.
 *
 * Usage:
 * ```tsx
 * <ErrorBoundary>
...
export class ErrorBoundary extends Component<ErrorBoundaryProps, State> {
  ...
  render(): ReactNode {
    if (this.state.hasError) {
      ...
      // Accessible error UI using design tokens
      return (
        <div
          role="alert"
          aria-live="assertive"
