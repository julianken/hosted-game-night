...
export interface KeyboardShortcutsModalProps {
  isOpen: boolean;
  onClose: () => void;
  /** List of shortcuts to display. Each app provides its own game-specific defaults. */
  shortcuts?: KeyboardShortcut[];
  /** Default shortcuts used when none are provided. */
 ...
 *
 * Pass app-specific `shortcuts` (or `defaultShortcuts`) to customize the list.
 */
export function KeyboardShortcutsModal({
  ...
  const displayedShortcuts = shortcuts ?? defaultShortcuts;
